        ...
        <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-10 xl:gap-14">
          ...
          >
            ...
            <div className="mt-6 flex flex-col items-center gap-3 sm:flex-row lg:justify-start">
              <Link
                href="#mission-vision"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-primary/20 transition-all hover:bg-primary/95 min-h-[44px]"
              >
                Our Mission &amp; Vision
          ...
          <motion.div
            ...
            className="order-2 hidden lg:flex w-full items-center justify-center overflow-visible min-h-[360px] xl:min-h-[420px]"
          >
